  ...
  return (
    ...
    <div className="flex flex-col min-h-screen w-full bg-cover bg-center bg-no-repeat p-4 transition-all duration-200 ease-in-out bg-[url('http://localhost:3000/background.png')] ">
      ...
      <div id="nav" className="flex justify-between py-4 px-8 items-center">
        <div>
          {/* Icon */}
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="rgba(255, 0, 0, 0.6)" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-handshake hover:scale-110 hover:-mt-2 hover:rotate-12 transition-all duration-200"><path d="m11 17 2 2a1 1 0 1 0 3-3" /><path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4" /><path d="m21 3 1 11h-2" /><path d="M3 3 2 14l6.5 6.5a1 1 0 1 0 3-3" /><path d="M3 4h8" /></svg>
          {/* <Image
            src={"/logo.svg"}
            alt="BlM Logo"
            width={32}
        ...
        <div>
          ...
          <div className="flex gap-x-6 text-white items-center">
            ...
            <span className="hover:-mt-2 hover:scale-110 transition-all duration-200">HISTORY</span>
            <div className="w-12 h-12 p-2 flex items-center justify-center bg-black/20 hover:bg-black/50 hover:border hover:border-red-500 hover:-rotate-12 hover:scale-110 backdrop-blur-2xl rounded-full transition-all duration-200">
    ...
    <div className="px-12 overflow-hidden flex justify-center items-center">
